...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_toolbar_component = CreateCourseToolbarComponent(page)
        self.create_course_exercises_component = CreateCourseExercisesToolbarViewComponent(page)
